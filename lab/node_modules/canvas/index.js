const Canvas = require('canvas/lib/canvas')
const Image = require('canvas/lib/image')
const CanvasRenderingContext2D = require('canvas/lib/context2d')
const CanvasPattern = require('canvas/lib/pattern')
const packageJson = require('canvas/package.json')
const bindings = require('canvas/lib/bindings')
const fs = require('fs')
const PNGStream = require('canvas/lib/pngstream')
const PDFStream = require('canvas/lib/pdfstream')
const JPEGStream = require('canvas/lib/jpegstream')
const { DOMPoint, DOMMatrix } = require('canvas/lib/DOMMatrix')
